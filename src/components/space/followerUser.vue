<template>
    <div class="follower-user">
        ...
        <div>
            <el-button v-if="followingTemp" round class="follow-button"
                       @click="cancelFollow"><span style="font-weight: bold">
                        <i class="el-icon-check"></i>相互关注</span>
            </el-button>

            <el-button v-else round class="un-follow-button" @click="toFollowing">
                <span style="font-weight: bold"><i class="el-icon-plus"></i>回关</span>
            </el-button>
        </div>
    </div>
</template>
...
.follower-user .username-introduce {
    flex: 1 1;
    margin: 0 12px;
    width: 0;
}
